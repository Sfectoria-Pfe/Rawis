...
const Code= ({update,setUpdate}) => {

const result = useLocation()

console.log(result.state.email,"email");
          ...
          <MDBRow className='g-0 d-flex align-items-center'>
            ...
            <MDBCol md='8'>
              ...
              <MDBCardBody>
                ...
                <MDBInput wrapperClass='mb-4' label='confirmer code' id='form1' type='text' onChange={(e) => setCode(e.target.value)} />
               
                <div className='text-center text-md-start mt-4 pt-2'>
                  <BtnWrapper onClick={async() => (
                   await axios.post("http://localhost:4000/auth/forgetPassword/verificationCode", {email:result.state.email,code}).then((res)=>{
